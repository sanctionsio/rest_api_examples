...
public class Programs {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.printf("Programs found: %s", joiner.toString());
    }

    /**
     * Example showing how to call the {@code /programs} function.
     */
    private static JSONObject invokePrograms() throws IOException {
